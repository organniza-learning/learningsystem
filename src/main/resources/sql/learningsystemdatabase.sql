...
CREATE TABLE `class` (
  ...
  `C_MAJOR` varbinary(30) DEFAULT NULL COMMENT '专业名称',
  PRIMARY KEY (`C_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

/*Data for the table `class` */

insert  into `class`(`C_ID`,`C_CLASSID`,`T_TEACHER`,`C_NAME`,`C_COLLEGE`,`C_MAJOR`) values (1,1,'1','15软件7班','计算机工程技术学院',NULL);
...
CREATE TABLE `student` (
  ...
  `STU_GRADE` varchar(2) DEFAULT NULL COMMENT '学生性别',
  `G_IDENTIFYING` int(6) DEFAULT NULL COMMENT '分组标识',
